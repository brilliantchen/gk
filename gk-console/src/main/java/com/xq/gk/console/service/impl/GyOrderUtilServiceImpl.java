...
import com.xq.gk.console.comm.util.DateUtil;
import com.xq.gk.console.entity.gy.resp.*;
import com.xq.gk.console.entity.kl.resp.KlBaseResp;
import com.xq.gk.console.entity.kl.resp.KlGoodsResp;
import com.xq.gk.console.service.GyApiService;
...
public class GyOrderUtilServiceImpl implements GyOrderUtilService {
    ...
    @Override
    public GyDeliverysResp getGyDeliverByThirdId(String thirdId) {
        try {
            if(StringUtils.isEmpty(thirdId)){
                return  null;
            }
            Map<String, Object> map = new HashMap<String, Object>();
            map.put("outer_code", thirdId);
            return gyApiService.getDeliverys(map);
        }catch (Exception e){
            return new GyDeliverysResp();
        }
